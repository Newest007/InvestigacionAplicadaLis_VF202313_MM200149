    ...
    <div class="container-flex">
        ...
        <div class="row p-5">
            ...
            <div class="container p-3">
                <center><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmarCompra">Finalizar compra</button></center>

                <div class="modal fade" id="confirmarCompra" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                            <div class="modal-header">
                                <center><h5 class="modal-title" id="exampleModalLabel">Confirmación de compra</h5></center>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <p class="text-center">¿Desea confirmar su compra?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                <a href="pages/paginaCorreo.php" class="btn btn-success">Confirmar</a>
                            </div>
                            </div>
                        </div>
                    </div>
